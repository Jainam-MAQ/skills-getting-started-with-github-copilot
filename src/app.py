...
activities = {
    ...
    "Basketball Team": {
        "description": "Practice team skills and friendly matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["kevin@mergington.edu", "sarah@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Play soccer games and build endurance",
    ...
    "Science Club": {
        ...
        "max_participants": 18,
        "participants": ["sophia@mergington.edu", "john@mergington.edu"]
    }
}
